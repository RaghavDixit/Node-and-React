...
let productList = await axios("https://pixabay.com/api/?key=18266844-e650db8a9ea5559b5c3139f85&q=yellow+flowers&image_type=photo&pretty=true");
console.log(countryList);
this.setState({countryList:countryList.data});
console.log(productList);
this.setState({productList:productList.data.hits});
}
bindDataToDropdown = ()=>{
